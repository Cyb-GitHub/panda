                ...
                <view class="popup-bg">
                    <view class="popup-content" :class="{'popup-content-show' : popup_show}">
                        <view class="update-wrap">
                            <image src="../static/images/app/img.png" class="top-img"></image>
                            <view class="content">
                                <text class="title">发现新版本V{{update_info.version}}</text>
                                <!-- 升级描述 -->
                                <view class="title-sub" v-if="update_info.note" v-html="update_info.note"></view>
                                <!-- 升级按钮 -->
                        ...
                        <image src="../static/images/app/close.png" class="close-ioc" @click="closeUpdate()" v-if="downstatus < 1 && update_info.force == 0"></image>
                    </view>
                </view>
            </view>
        </view>
    ...
    export default {
        ...
        methods: {
            ...
            startUpdate() {
				...
				console.log(this.update_info.now_url)
    ...
    .sche-wrap {
        ...
        .sche-bg {
            ...
            .sche-bg-jindu {
                ...
                min-width: 40rpx;
                border-radius: 100px;
                background: url(../static/images/app/round.png) #5775e7 center right 4rpx no-repeat;
